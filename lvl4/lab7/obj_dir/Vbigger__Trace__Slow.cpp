...
void Vbigger::traceInitThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+449,"d_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+449,"bigger d_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+457,"bigger d_in", false,-1, 7,0);
        vcdp->declBit(c+465,"bigger instr_valid", false,-1);
        ...
        vcdp->declBus(c+449,"bigger instance3 d_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+473,"bigger instance3 reg_inst starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+473,"bigger instance3 reg_s starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+473,"bigger instance3 reg_c starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[0] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[1] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[2] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[3] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[4] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[5] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[6] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+481,"bigger instance3 genblk1[7] reg_out starting", false,-1, 15,0);
...
void Vbigger::traceFullThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+449,(vlTOPp->d_out),16);
        vcdp->fullBus(c+457,(vlTOPp->bigger__DOT__d_in),8);
        vcdp->fullBit(c+465,(vlTOPp->bigger__DOT__instr_valid));
        vcdp->fullBus(c+473,(0U),16);
        vcdp->fullBus(c+481,(0xaU),16);
    }
}
