...
void Vbigger::traceChgThis__5(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+297,(vlTOPp->bigger__DOT__addr),8);
        vcdp->chgBus(c+305,((0xffU & ((IData)(1U) + (IData)(vlTOPp->bigger__DOT__addr)))),8);
    }
}
...
void Vbigger::traceChgThis__6(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+313,(vlTOPp->bigger__DOT__instance3__DOT__instruction),16);
        vcdp->chgBus(c+321,(vlTOPp->bigger__DOT__instance3__DOT__regs),16);
        vcdp->chgBus(c+329,(vlTOPp->bigger__DOT__instance3__DOT__regc),16);
        vcdp->chgBus(c+337,(vlTOPp->bigger__DOT__instance3__DOT__cpu_inst__DOT__cur_state),2);
...
void Vbigger::traceChgThis__8(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+457,(vlTOPp->d_out),16);
    }
}
