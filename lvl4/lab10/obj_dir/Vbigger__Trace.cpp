...
void Vbigger::traceChgThis__5(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+273,(vlTOPp->bigger__DOT__new_pc),8);
    }
}
...
void Vbigger::traceChgThis__7(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+305,(vlTOPp->bigger__DOT__instance3__DOT__instruction),16);
        vcdp->chgBus(c+313,(vlTOPp->bigger__DOT__instance3__DOT__regs),16);
        vcdp->chgBus(c+321,(vlTOPp->bigger__DOT__instance3__DOT__regc),16);
        vcdp->chgBus(c+329,(vlTOPp->bigger__DOT__instance3__DOT__cpu_inst__DOT__cur_state),2);
        vcdp->chgBus(c+337,((3U & (IData)(vlTOPp->bigger__DOT__instance3__DOT__instruction))),2);
        vcdp->chgBus(c+345,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__0__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+353,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__1__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+361,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__2__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+369,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__3__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+377,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__4__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+385,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__5__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+393,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__6__KET____DOT__reg_out__mux_out),16);
        vcdp->chgBus(c+401,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__7__KET____DOT__reg_out__mux_out),16);
    }
}
...
void Vbigger::traceChgThis__8(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+409,(vlTOPp->bigger__DOT__mem_out),16);
        vcdp->chgBus(c+417,(vlTOPp->bigger__DOT__addr),8);
        vcdp->chgBus(c+425,((3U & ((IData)(vlTOPp->bigger__DOT__mem_out) 
                                   >> 2U))),2);
        vcdp->chgBus(c+433,((0xffU & ((IData)(vlTOPp->bigger__DOT__mem_out) 
                                      >> 4U))),8);
        vcdp->chgBus(c+441,((3U & (IData)(vlTOPp->bigger__DOT__mem_out))),2);
    }
}
