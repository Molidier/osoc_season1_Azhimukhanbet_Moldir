...
void Vbigger::traceInitThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+409,"bigger mem_out", false,-1, 15,0);
        vcdp->declBus(c+417,"bigger addr", false,-1, 7,0);
        vcdp->declBus(c+273,"bigger new_pc", false,-1, 7,0);
        vcdp->declBus(c+417,"bigger instance4 address", false,-1, 7,0);
        vcdp->declBus(c+409,"bigger instance4 instruction", false,-1, 15,0);
        vcdp->declBus(c+489,"bigger instance4 last_alu_result", false,-1, 15,0);
        vcdp->declBus(c+273,"bigger instance4 new_pc", false,-1, 7,0);
        vcdp->declBus(c+425,"bigger instance4 branch_cond", false,-1, 1,0);
        vcdp->declBus(c+433,"bigger instance4 immediate", false,-1, 7,0);
        vcdp->declBus(c+441,"bigger instance4 format", false,-1, 1,0);
        ...
        vcdp->declBus(c+417,"bigger instance1 d_out", false,-1, 7,0);
        vcdp->declBit(c+449,"bigger instance2 clk", false,-1);
        vcdp->declBus(c+417,"bigger instance2 addr", false,-1, 7,0);
        vcdp->declBus(c+409,"bigger instance2 out", false,-1, 15,0);
        ...
        vcdp->declBus(c+409,"bigger instance3 d_instr", false,-1, 15,0);
        ...
        vcdp->declBus(c+337,"bigger instance3 cpu_inst format", false,-1, 1,0);
        ...
        vcdp->declBus(c+409,"bigger instance3 reg_inst d_in", false,-1, 15,0);
        ...
        vcdp->declBus(c+345,"bigger instance3 genblk1[0] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+353,"bigger instance3 genblk1[1] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+361,"bigger instance3 genblk1[2] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+369,"bigger instance3 genblk1[3] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+377,"bigger instance3 genblk1[4] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+385,"bigger instance3 genblk1[5] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+393,"bigger instance3 genblk1[6] reg_out mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+401,"bigger instance3 genblk1[7] reg_out mux_out", false,-1, 15,0);
    }
}
...
void Vbigger::traceFullThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBit(c+265,((1U & ((IData)(vlTOPp->bigger__DOT__instance3__DOT__en) 
                                    >> 7U))));
        vcdp->fullBus(c+273,(vlTOPp->bigger__DOT__new_pc),8);
        ...
        vcdp->fullBus(c+337,((3U & (IData)(vlTOPp->bigger__DOT__instance3__DOT__instruction))),2);
        vcdp->fullBus(c+345,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__0__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+353,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__1__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+361,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__2__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+369,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__3__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+377,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__4__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+385,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__5__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+393,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__6__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+401,(vlTOPp->bigger__DOT__instance3__DOT____Vcellout__genblk1__BRA__7__KET____DOT__reg_out__mux_out),16);
        vcdp->fullBus(c+409,(vlTOPp->bigger__DOT__mem_out),16);
        vcdp->fullBus(c+417,(vlTOPp->bigger__DOT__addr),8);
        vcdp->fullBus(c+425,((3U & ((IData)(vlTOPp->bigger__DOT__mem_out) 
                                    >> 2U))),2);
        vcdp->fullBus(c+433,((0xffU & ((IData)(vlTOPp->bigger__DOT__mem_out) 
                                       >> 4U))),8);
        vcdp->fullBus(c+441,((3U & (IData)(vlTOPp->bigger__DOT__mem_out))),2);
