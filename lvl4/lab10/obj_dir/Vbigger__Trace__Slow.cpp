...
void Vbigger::traceInitThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+497,"bigger d_in", false,-1, 7,0);
        vcdp->declBit(c+505,"bigger instr_valid", false,-1);
        ...
        vcdp->declBit(c+473,"bigger instance4 done", false,-1);
        ...
        vcdp->declBus(c+513,"bigger instance3 mux_inst def_val", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 reg_inst starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 reg_s starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 reg_c starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[0] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[1] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[2] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[3] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[4] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[5] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[6] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+513,"bigger instance3 genblk1[7] reg_out starting", false,-1, 15,0);
...
void Vbigger::traceFullThis__1(Vbigger__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+497,(vlTOPp->bigger__DOT__d_in),8);
        vcdp->fullBit(c+505,(vlTOPp->bigger__DOT__instr_valid));
