...
void Vbitty::traceInitThis__1(Vbitty__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBit(c+393,"done", false,-1);
        ...
        vcdp->declBit(c+393,"bitty done", false,-1);
        vcdp->declBus(c+265,"bitty d_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+273,"bitty instruction", false,-1, 15,0);
        vcdp->declBus(c+281,"bitty regs", false,-1, 15,0);
        vcdp->declBus(c+265,"bitty regc", false,-1, 15,0);
        ...
        vcdp->declBus(c+401,"bitty reg_inst starting", false,-1, 15,0);
        vcdp->declBit(c+377,"bitty reg_inst reset", false,-1);
        vcdp->declBus(c+273,"bitty reg_inst mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+401,"bitty reg_s starting", false,-1, 15,0);
        vcdp->declBit(c+377,"bitty reg_s reset", false,-1);
        vcdp->declBus(c+281,"bitty reg_s mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+401,"bitty reg_c starting", false,-1, 15,0);
        vcdp->declBit(c+377,"bitty reg_c reset", false,-1);
        vcdp->declBus(c+265,"bitty reg_c mux_out", false,-1, 15,0);
        ...
        vcdp->declBus(c+273,"bitty cpu_inst d_inst", false,-1, 15,0);
        vcdp->declBus(c+137,"bitty cpu_inst mux_sel", false,-1, 2,0);
        vcdp->declBit(c+393,"bitty cpu_inst done", false,-1);
        ...
        vcdp->declBus(c+281,"bitty alu_inst in_a", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[0] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[0] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[1] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[1] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[2] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[2] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[3] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[3] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[4] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[4] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[5] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[5] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[6] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[6] reg_out starting", false,-1, 15,0);
        ...
        vcdp->declBus(c+265,"bitty genblk1[7] reg_out d_in", false,-1, 15,0);
        vcdp->declBus(c+409,"bitty genblk1[7] reg_out starting", false,-1, 15,0);
...
void Vbitty::traceFullThis__1(Vbitty__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBit(c+257,((1U & ((IData)(vlTOPp->bitty__DOT__en) 
                                    >> 7U))));
        vcdp->fullBus(c+265,(vlTOPp->bitty__DOT__regc),16);
        vcdp->fullBus(c+273,(vlTOPp->bitty__DOT__instruction),16);
        vcdp->fullBus(c+281,(vlTOPp->bitty__DOT__regs),16);
        ...
        vcdp->fullBit(c+393,(vlTOPp->done));
        vcdp->fullBus(c+401,(0U),16);
        vcdp->fullBus(c+409,(0xaU),16);
    }
}
